...
def can_be_found_updated_and_saved
  ...
  selected_movie = Movie.find_by(title: "Awesome Flick")
  selected_movie.update(title: "Even Awesomer Flick")
  selected_movie.save
end

def can_update_using_update_method
  Movie.create(title: "Wat?")
  renamed_movie = Movie.find_by(title: "Wat?")
  renamed_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  deleted_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
