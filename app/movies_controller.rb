...
def can_be_found_updated_and_saved
  ...
  user = Movie.find_by(title: 'Awesome Flick')
  user.title = 'Even Awesomer Flick'
  user.save
end
...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    ...
    movie = Movie.update(title: "A Movie")
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  user = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  user.destroy
end
