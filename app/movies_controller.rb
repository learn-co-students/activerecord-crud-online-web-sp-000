...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.find_by(args = {title: "Title", release_date: 2000, director: "Me"})
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by
  # release date descending
  relevant_movies = Movie.where("release_date > 2002")
  relevant_movies.sort_by{ |movies| movies.release_date }.reverse
end
...
def can_be_found_updated_and_saved
  ...
  movie.update_column(:title, "Even Awesomer Flick")
  movie.save
  movie
end
