...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.all.find_or_create_by(title: "Title", release_date: 2000, director: "Me")
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by 
  # release date descending
  Movie.all.find_by_sql("SELECT * FROM movies 
    WHERE release_date > 2002 ORDER BY release_date desc")
end
