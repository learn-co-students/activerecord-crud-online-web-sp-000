...
def can_be_found_updated_and_saved
  ...
  find = Movie.create(title: "Awesome Flick")
  find = Movie.find_by(title: "Awesome Flick")
  find.update(title: "Even Awesomer Flick")
  find.save
end
...
def can_destroy_a_single_item
  ...
  delete_one = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  delete_one.delete
end
