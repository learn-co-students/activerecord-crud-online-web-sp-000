...
def can_find_using_where_clause_and_be_sorted
  ...
  array = Movie.where("release_date > 2002")
  array.order(release_date: :desc)
end

def can_be_found_updated_and_saved
  # Updtate the title "Awesome Flick" to "Even Awesomer Flick", save it, then return it
  Movie.create(title: "Awesome Flick")
  obj = Movie.find_by title: "Awesome Flick"
  obj.update(title: "Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  obj = Movie.find_by title: "Wat?"
  obj.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  obj = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  obj.destroy
end
