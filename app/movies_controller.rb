...
def can_find_by_multiple_attributes(title: "Title", release_date: "2000", director: "Me")
  ...
  # release_date == 2000
  # director == "Me"
  Movie.where(title: title, release_date: release_date, director: director).first
...
def can_find_using_where_clause_and_be_sorted(release_date: 2002)
  ...
  Movie.where("release_date > ?", release_date).order(release_date: :desc)
...
def can_update_using_update_method
  ...
  m = Movie.find_by(title: "Wat?").update(title: "Wat, huh?")
end
