...
def can_be_found_updated_and_saved
  ...
  i = Movie.find_by title: 'Awesome Flick'
  i.title = "Even Awesomer Flick"
  i.save
end
...
def can_update_using_update_method
  ...
  i = Movie.find_by title: 'Wat?'
  i.update(title: 'Wat, huh?')
end
...
def can_destroy_a_single_item
  ...
  i = Movie.where(title: 'That One Where the Guy Kicks Another Guy Once').ids
  Movie.destroy(i)
end
